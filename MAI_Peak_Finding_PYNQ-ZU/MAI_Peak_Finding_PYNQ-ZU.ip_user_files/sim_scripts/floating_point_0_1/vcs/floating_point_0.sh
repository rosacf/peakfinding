...
compile()
{
  ...
  vlogan -work floating_point_v7_1_15 $vlogan_opts +v2k +incdir+"E:/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"E:/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../full_design.gen/sources_1/ip/floating_point_0_1/sim/floating_point_0.v" \
  2>&1 | tee -a vlogan.log
