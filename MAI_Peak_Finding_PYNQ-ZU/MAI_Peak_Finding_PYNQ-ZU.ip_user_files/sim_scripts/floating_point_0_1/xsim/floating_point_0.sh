...
#
# Generated by Vivado on Fri Apr 04 01:43:37 +0100 2025
...
simulate()
{
  xsim  floating_point_0 -key {Behavioral:sim_1:Functional:floating_point_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_36cd.protoinst" -protoinst "protoinst_files/bd_365d.protoinst" -protoinst "protoinst_files/bd_36ad.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
